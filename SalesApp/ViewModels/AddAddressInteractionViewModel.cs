...
namespace SalesApp.ViewModels
{
    public class AddAddressInteractionViewModel : ViewModelBase
    {
        ...
        public AddAddressInteractionViewModel(IAddressService addressService, IProductService productService, ISettingsService settingsService)
        {
        ...
        public override async Task InitializeAsync(object navigationData)
        {
            ...
            var products = await _productService.GetProductsForUser(_settingsService.LoggedInUser);
        ...
        public async Task SaveInteractionAsync()
        {
            ...
            {
                UserId = _settingsService.LoggedInUser.Id,
