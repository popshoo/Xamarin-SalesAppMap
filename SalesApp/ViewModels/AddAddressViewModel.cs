...
namespace SalesApp.ViewModels
{
    public class AddAddressViewModel : ViewModelBase
    {
        ...
        public AddAddressViewModel(ISettingsService settingsService, IAddressService addressService)
        {
        ...
        public override async Task InitializeAsync(object navigationData)
        {
            ...
            Address.City = _settingsService.Location.City;
            Address.Province = _settingsService.Location.State;
            Address.PostalCode = _settingsService.Location.Zip;
            RaisePropertyChanged(() => Address);
        }
